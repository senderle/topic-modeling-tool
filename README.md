...
<img src="doc/quickstart/main-tool-window.png" alt="Main tool window" title="Main tool window" width="631" height="691" />
...
<img src="doc/quickstart/input-dir-button.png" alt="Input directory button" title="Input directory button" width="251" height="34" />
...
<img src="doc/quickstart/input-select.png" alt="Select input" title="Select input" width="662" height="534" />
...
<img src="doc/quickstart/optional-settings-button.png" alt="Optional settings button" title="Optional settings button" width="160" height="30" />

A window like this should open:

<img src="doc/quickstart/optional-settings.png" alt="Optional settings window" title="Optional settings window" width="666" height="553" />
...
<img src="doc/quickstart/pivot-table-menu-item.png" alt="Pivot table menu item" title="Pivot table menu item" width="314" height="404" />
...
<img src="doc/quickstart/pivot-table-create-window.png" alt="Create pivot table window" title="Create pivot table window" width="495" height="451" />
...
<img src="doc/quickstart/pivot-table-builder-empty.png" alt="Pivot table builder" title="Pivot table builder" width="331" height="524" />
...
<img src="doc/quickstart/pivot-table-select-year.png" alt="Select year" title="Select year" width="121" height="60" />

Once you've clikced on the "Year" check box, a "Year" entry will appear in the "Values" box, like so:

<img src="doc/quickstart/pivot-table-year-selected.png" alt="Year selected" title="Year selected" width="331" height="524" />
...
<img src="doc/quickstart/pivot-table-year-to-row.png" alt="Move year to row" title="Move year to row" width="331" height="524" />
...
<img src="doc/quickstart/pivot-table-year-row-example.png" alt="Empty year table" title="Empty year table" width="430" height="523" />

In this example, one of the topics is labeled "17 welfare children social." Let's pick that one.

<img src="doc/quickstart/pivot-table-select-welfare.png" alt="Select welfare column" title="Select welfare column" width="236" height="97" />

Once we've done so, it will appear in the "Values" box.

<img src="doc/quickstart/pivot-table-sum-welfare.png" alt="Welfare sum" title="Welfare sum" width="141" height="56" />
...
<img src="doc/quickstart/pivot-table-select-average-welfare.png" alt="Select welfare average" title="Select welfare average" width="468" height="355" />
...
<img src="doc/quickstart/pivot-table-year-welfare-avg-example.png" alt="Average welfare table" title="Average welfare table" width="306" height="545" />

From this we can quickly build a chart. First, select the "Charts" tab:

<img src="doc/quickstart/pivot-table-select-chart.png" alt="Select chart" title="Select chart" width="344" height="102" />

Then select "Line":

<img src="doc/quickstart/pivot-table-select-line-chart.png" alt="Select line chart" title="Select line chart" width="294" height="436" />

The chart will automatically be generated.

<img src="doc/quickstart/pivot-table-basic-chart.png" alt="Basic pivot table chart" title="Basic pivot table chart" width="405" height="259" />
...
<img src="doc/quickstart/pivot-table-improved-chart.png" alt="Improved pivot table chart" title="Improved pivot table chart" width="654" height="427" />
